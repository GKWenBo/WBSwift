...
//        let expectation = XCTestExpectation(description: "Download from \(String(describing: testURL))")
//        let remotePublisher = URLSession.shared.dataTaskPublisher(for: self.testURL!)
...
//                }
//            } receiveValue: { (decodeResponse) in
//                XCTAssertNotNil(decodeResponse)
//                XCTAssertTrue(decodeResponse.valid)
//            }
//        
//        XCTAssertNotNil(remotePublisher)
//        wait(for: [expectation], timeout: 5.0)
//    }
//    
