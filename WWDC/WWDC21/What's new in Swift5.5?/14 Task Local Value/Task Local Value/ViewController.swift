...
/*
 如果之前你从事过多线程方面的开发，一定对线程局部存储（TLS）这个东西并不陌生。这种类型的对象把线程当作自己的容器，在线程开始时创建，线程结束时回收。这种技术被广泛地应用在多线程环境下的调试以及性能分析工具的开发中。比如：Thread.current.threadDictionary
